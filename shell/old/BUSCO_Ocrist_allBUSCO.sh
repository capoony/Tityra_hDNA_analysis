...
awk 'NR>1 {print $1}' ${WD}/results/phylogeny/Oxyruncus_cristatus_BUSCO/Tityra_leucura_Oxyruncus_cristatus_PE.coverage.txt \
...
mkdir -p ${WD}/results/phylogeny_DNA_Ocrist_all/concatenated
...
mkdir -p ${WD}/results/phylogeny_DNA_Ocrist_all/concatenated/busco_dna
...
while IFS=$"," read -r Name; do
    ...
    while IFS=$"," read -r gene; do
        ...
        cp ${WD}/results/phylogeny/BUSCO/${Name}/run_aves_odb10/busco_sequences/single_copy_busco_sequences/${gene}.fna \
            ${WD}/results/phylogeny_DNA_Ocrist_all/concatenated/busco_dna/${Name}_${gene}
        sed -i 's/^>/>'${Name}'|/g' ${WD}/results/phylogeny_DNA_Ocrist_all/concatenated/busco_dna/${Name}_${gene}
    done <${WD}/results/phylogeny/Oxyruncus_cristatus_BUSCO/Tityra_leucura_Oxyruncus_cristatus_PE.genes.txt
...
while read gene; do
    ...
    cat ${WD}/results/phylogeny_DNA_Ocrist_all/concatenated/busco_dna/*_${gene}* \
