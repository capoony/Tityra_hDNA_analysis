...
INPUT_DIR="${WD}/results/combined_mito_genes_assembly"
OUTPUT_DIR="${WD}/results/phylogenetic_analysis_assembly"
...
# List of genes to process (mitochondrial)
