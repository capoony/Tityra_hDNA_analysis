  ...
  cd /media/inter/mkapun/projects/Tityra/results/denovo/results/AssemblyQC/Busco

  busco -i ../../../output/Tityra_ILL.fa     -o Tityra     -m genome     -c 150     -f     -l vertebrata_odb10
